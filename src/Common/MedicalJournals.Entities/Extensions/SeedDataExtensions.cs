...
namespace MedicalJournals.Entities.Extensions
{
    ...
    public static class SeedDataExtensions
    {
        ...
        public static void SeedData(JournalContext context, ILogger logger)
        {
            ...
            ApplyData(context, true);
        }

        private static void ApplyData(JournalContext context, bool isInMemoryDatabase)
        {
            ...
            if (!context.Categories.Any())
            {
                ...
                SwitchIdentity(context, "Categories", false, isInMemoryDatabase);
            }

            if (!context.Countries.Any())
            {
                SwitchIdentity(context, "Countries", true, isInMemoryDatabase);
                ...
                context.SaveChanges();
                SwitchIdentity(context, "Countries", false, isInMemoryDatabase);
        ...
        private static void SwitchIdentity(JournalContext context, string table, bool isOn, bool isInMemoryDatabase)
        {
            if(!isInMemoryDatabase)
                context.Database.ExecuteSqlCommand(isOn
