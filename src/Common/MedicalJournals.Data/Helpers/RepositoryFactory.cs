...
namespace MedicalJournals.Data.Helpers
{
    ...
    public class RepositoryFactory
    {
        ...
        /// </summary>
        /// <remarks>
        /// MODIFY THIS METHOD TO ADD CUSTOM CODE FACTORY FUNCTIONS
        /// </remarks>
        private IDictionary<Type, Func<DbContext, object>> GetTrainingFactories()
        {
        ...
        {
            _repositoryFactories = GetTrainingFactories();
        }
        ...
        public Func<DbContext, object> GetMockRepositoryFactoryForEntityType<T>() where T : class
        {
            return GetRepositoryFactory<T>() ?? DefaultEntityRepositoryFactory<T>();
        }
